...
import Invoker from '@editor/invoker';
import UI from '@editor/ui';
import action from '@editor/action';
import commandFactory from '@editor/factory/command';
import Graphics from '@editor/graphics';
import { makeSelectionUndoData, makeSelectionUndoDatum } from '@editor/helper/selectionModifyHelper';
import { sendHostName, getObjectType } from '@editor/util';
import {

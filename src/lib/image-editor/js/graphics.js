...
import ImageLoader from '@editor/component/imageLoader';
import Cropper from '@editor/component/cropper';
import Flip from '@editor/component/flip';
import Rotation from '@editor/component/rotation';
import FreeDrawing from '@editor/component/freeDrawing';
import Line from '@editor/component/line';
import Text from '@editor/component/text';
import Icon from '@editor/component/icon';
import Filter from '@editor/component/filter';
import Shape from '@editor/component/shape';
import Zoom from '@editor/component/zoom';
import CropperDrawingMode from '@editor/drawingMode/cropper';
import FreeDrawingMode from '@editor/drawingMode/freeDrawing';
import LineDrawingMode from '@editor/drawingMode/lineDrawing';
import ShapeDrawingMode from '@editor/drawingMode/shape';
import TextDrawingMode from '@editor/drawingMode/text';
import IconDrawingMode from '@editor/drawingMode/icon';
import ZoomDrawingMode from '@editor/drawingMode/zoom';
import {
  makeSelectionUndoData,
  makeSelectionUndoDatum,
  setCachedUndoDataForDimension,
} from '@editor/helper/selectionModifyHelper';
import { getProperties, includes, isShape, stamp } from '@editor/util';
import {
...
import Resize from '@editor/component/resize';
import ResizeDrawingMode from '@editor/drawingMode/resize';

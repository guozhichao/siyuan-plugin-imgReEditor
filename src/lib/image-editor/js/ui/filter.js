...
import Colorpicker from '@editor/ui/tools/colorpicker';
import Range from '@editor/ui/tools/range';
import Submenu from '@editor/ui/submenuBase';
import templateHtml from '@editor/ui/template/submenu/filter';
import { toInteger, toCamelCase, assignmentForDestroy } from '@editor/util';
import { defaultFilterRangeValues as FILTER_RANGE, eventNames, selectorNames } from '@editor/consts';

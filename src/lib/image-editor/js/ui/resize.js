...
import templateHtml from '@editor/ui/template/submenu/resize';
import { assignmentForDestroy, toInteger } from '@editor/util';
import Range from '@editor/ui/tools/range';
import { defaultResizePixelValues } from '@editor/consts';

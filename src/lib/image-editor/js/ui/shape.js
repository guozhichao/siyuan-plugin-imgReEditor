...
import templateHtml from '@editor/ui/template/submenu/shape';
import { toInteger, assignmentForDestroy } from '@editor/util';
import { defaultShapeStrokeValues, eventNames, selectorNames } from '@editor/consts';

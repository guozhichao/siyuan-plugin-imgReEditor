...
import templateHtml from '@editor/ui/template/submenu/icon';
import { isSupportFileApi, assignmentForDestroy } from '@editor/util';
import { defaultIconPath, eventNames, selectorNames } from '@editor/consts';

...
import templateHtml from '@editor/ui/template/submenu/draw';
import { assignmentForDestroy, getRgb } from '@editor/util';
import { defaultDrawRangeValues, eventNames, selectorNames } from '@editor/consts';

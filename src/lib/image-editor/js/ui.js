...
import { getSelector, assignmentForDestroy, cls, getHistoryTitle, isSilentCommand } from '@editor/util';
import {
  ZOOM_HELP_MENUS,
  COMMAND_HELP_MENUS,
  DELETE_HELP_MENUS,
...
import mainContainer from '@editor/ui/template/mainContainer';
import controls from '@editor/ui/template/controls';

import Theme from '@editor/ui/theme/theme';
import Shape from '@editor/ui/shape';
import Crop from '@editor/ui/crop';
import Resize from '@editor/ui/resize';
import Flip from '@editor/ui/flip';
import Rotate from '@editor/ui/rotate';
import Text from '@editor/ui/text';
import Mask from '@editor/ui/mask';
import Icon from '@editor/ui/icon';
import Draw from '@editor/ui/draw';
import Filter from '@editor/ui/filter';
import History from '@editor/ui/history';
import Locale from '@editor/ui/locale/locale';
